...
public class Job implements Serializable {
    ...
    public Job(int id,String name, int sex, Integer age, String job, String specialty, String experience, String studyeffort, String school, String tel, String email, Date createtime, String content, int isstock) {
        this.id=id;
        this.name = name;
        this.sex = sex;
        this.age = age;
