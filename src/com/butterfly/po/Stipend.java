...
public class Stipend implements Serializable {
    ...
    private	int effect; //绩效

    public Stipend(int effect, int departmentId,String departmentNameSrc, String name, Float basic, Float eat, Float house, Date granttime, Float duty, Float scot, Float punishment, Float other, Float totalize) {
