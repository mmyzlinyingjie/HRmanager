...
<%
	List<Job> jobList = (List<Job>) ActionContext.getContext().getSession().get("jobList");
...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" align="center">应聘信息列表</th>
  </tr>
	<%
		//显示当前页数据
		out.print("<center>");
		...
		for (Job job : jobList) {
			...
			out.print("<td >" + "<a href=\"job!Delete.action?id=" + job.getId() + "\"" + ">删除</a>  </td>");
			out.print("</tr>"); 
		}
		out.print("</table>");
		out.print("</center>");
