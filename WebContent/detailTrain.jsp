...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" align="center">培训计划列表</th>
  </tr>
	<%
		//显示当前页数据
		out.print("<center>");
		...
		for (Train train : trainList) {
			...
			out.print("<td >" + StringUtil.convert(train.getIsFinish()) + "</td>");
			out.print("<td >" + "<a href=\"train!Delete.action?id=" + train.getId() + "\"" + ">删除</a>  "  + "<a href=\"train!Finish.action?id=" + train.getId() + "\"" + ">完成</a>  " + "</td>");
			out.print("</tr>");
		}
		out.print("</table>");
		out.print("</center>");
