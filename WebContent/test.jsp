...
<body>
	...
	<div id="tb" >
		<div>
		<a href="javascript:openDepartmentAddDialog()" class="easyui-linkbutton" data-options="iconCls:'icon-add'" plain="true">添加ss</a>
	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:220px;padding:20px 10px 0;" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post" >
			<table>
				<tr>
					<td>&nbsp;编号:&nbsp;</td>
					<td><input type="text" name="employee.employeeNo" id="employeeNo" class="easyui-validatebox" ></td>
					<td>&nbsp;姓名:&nbsp;</td>
					<td><input type="text" name="employee.name" id="name" class="easyui-validatebox"  ></td>
				</tr>	
				<tr hidden="true">
					<td>&nbsp;性别:&nbsp;</td>
					<td><select class="easyui-combobox" name="employee.sex" id="sex"   panelHeight="auto" style="width:85px;">
					...
					<td>&nbsp;出生日期:&nbsp;</td>
					<td><input type="text" class="easyui-datebox" name="employee.birthday" id="birthday"   /></td>
					<td>&nbsp;民族:&nbsp;</td>
					...
					<td>&nbsp;部门:&nbsp;</td>
					<td><input class="easyui-combobox" id="departmentId" name="employee.departmentId" size="8"  /></td>
					<td>&nbsp;职务:&nbsp;</td>
					<td><input type="text" name="employee.position" id="position" class="easyui-validatebox"  ></td>
				</tr>		
				<tr>
					<td>&nbsp;基本工资:&nbsp;</td>
					<td><input type="text" name="employee.baseMoney" id="baseMoney" class="easyui-validatebox"  ></td>
					<td>&nbsp;加班费:&nbsp;</td>
					<td><input type="text" name="employee.overtime" id="overtime" class="easyui-validatebox"  ></td>
				</tr>
				<tr>
					<td>&nbsp;工龄工资:&nbsp;</td>
					<td><input type="text" name="employee.age" id="age" class="easyui-validatebox"  ></td>
					<td>&nbsp;考勤费:&nbsp;</td>
					<td><input type="text" name="employee.check1" id="check1" class="easyui-validatebox"  ></td>
				</tr>
				<tr>
					<td>&nbsp;旷工费:&nbsp;</td>
					<td><input type="text" name="employee.absent" id="absent" class="easyui-validatebox"  ></td>
					<td>&nbsp;保险费:&nbsp;</td>
					<td><input type="text" name="employee.safety" id="safety" class="easyui-validatebox"  ></td>
				</tr>				
			</table>			
		</form>
	</div>
